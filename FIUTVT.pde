...
final int ATDEF=2;    //Atributo de defensa
final int ATHPM=3;    //Atributo de vida
final boolean ATUP=true;
final boolean ATDN=false;
final int CLAWA=0; //loseta agua
final int CLTRR=1; //loseta desierto
final int CLBSQ=2; //loseta bosque
final int CLPST=3; //loseta pasto
final int CLTND=4; //loseta tienda
final int CLPTEVT=5; //loseta puente vertical
final int CLPTEHT=6; //loseta puente horizontal
